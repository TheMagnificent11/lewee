...
internal sealed class CreateCustomerEndpoint : CommandEndpoint<CreateCustomerCommand>
{
    ...
    public override async Task HandleAsync(CreateCustomerCommand req, CancellationToken ct)
    {
        ...
        var command = new Application.Customers.CreateCustomerCommand(req.ExternalUserId, this.CorrelationId);
