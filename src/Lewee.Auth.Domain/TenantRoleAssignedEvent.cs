...
/// </summary>
public sealed class TenantRoleAssignedEvent : DomainEvent
{
    /// <summary>
    /// Initializes a new instance of the <see cref="TenantRoleAssignedEvent"/> class.
    /// </summary>
    /// <param name="userEntityId">User entity ID.</param>
    /// <param name="tenantEntityId">Tenant entity ID.</param>
    /// <param name="roleId">Role ID.</param>
    /// <param name="correlationId">Correlation ID.</param>
    public TenantRoleAssignedEvent(Guid userEntityId, Guid tenantEntityId, Guid roleId, Guid correlationId)
        : base(correlationId)
    {
