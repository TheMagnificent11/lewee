...
internal sealed class AzureSignalRClientEventHandler : INotificationHandler<ClientEvent>
{
    private readonly ServiceManager serviceManager;
    private readonly ILogger logger;

    public AzureSignalRClientEventHandler(
        ServiceManager serviceManager,
        ILogger<AzureSignalRClientEventHandler> logger)
    {
